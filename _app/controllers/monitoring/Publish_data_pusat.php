...
class Publish_data_pusat extends Backend_Controller {

	public function __construct() {
		parent::__construct();
		$this->dir = base_url( 'monitoring/publish_data_pusat/' );
	...
	function show()	{
		...
		$this->template->content( "verivali/view_publish_data_pusat", $data );
	...
	function act_publish()
	{
		...
		for ($i=0; $i < count($ids); $i++) {
			...
			$data_log['description'] = 'Publish dari P0 ke P1';
			$data_log['stereotype'] = 'P1';
