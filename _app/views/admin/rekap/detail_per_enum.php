            ...
            <div class="form_dt_search hidden" id="form_dt_search">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-3">
                        <input type="text" id="phone" class="form-control" value="" placeholder="0813223xxx">
                    </div>
                    <div class="form-group col-sm-3">
                        <input type="text" id="enum" class="form-control" value="" placeholder="Enumerator">
                    </div>
                    <div class="form-group col-sm-3">
                        <input type="text" id="krt" class="form-control" value="" placeholder="Nama KRT">
                    </div>
                    <div class="form-group col-sm-3">
                        <input type="text" id="art" class="form-control" value="" placeholder="Nama ART">
                    </div>
                    <div class="col-sm-3">
