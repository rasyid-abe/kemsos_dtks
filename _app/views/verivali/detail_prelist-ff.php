                                                ...
                                                <div class="btn-group-vertical" role="group" aria-label="Vertical button group">
                                                    ...
                                                    ?>
                                                        <?php if ($artdata['stereotype'] == 'MK' || $artdata['stereotype'] == 'MKa' || $artdata['stereotype'] == 'MKb') { ?>
                                                            <a href="<?php echo base_url('korkab/qc_art/act_approve_per_art/' . enc(['id' => $artdata['id']])) ?>" class="btn btn-success bg-light-success btn-sm" onclick="return confirm('Apakah Anda yakin ingin APPROVE data ini?')">
                                                                <i class="ft ft-trending-up"></i> Approve
                                                            </a>
                                                        <?php } ?>
                                                        <?php if ($artdata['stereotype'] == 'MK' || $artdata['stereotype'] == 'MKa') { ?>
                                                            <a href="javascript:;" data-id="<?php echo $artdata['id'] ?>" data-proses_id="<?php echo $artdata['proses_id'] ?>" data-nama_art="<?php echo $artdata['nama_art'] ?>" data-nik="<?php echo $artdata['nik'] ?>" data-keberadaan_art="<?php echo $artdata['keberadaan_art'] ?>" data-jenis_kelamin="<?php echo $artdata['jenis_kelamin'] ?>" data-tempat_lahir="<?php echo $artdata['tempat_lahir'] ?>" data-tanggal_lahir="<?php echo $artdata['tanggal_lahir'] ?>" data-hubungan_kepkel="<?php echo $artdata['hubungan_kepkel'] ?>" data-stereotype="<?php echo $artdata['stereotype'] ?>" data-toggle="modal" data-target="#edit-data" class="btn btn-danger bg-light-danger btn-sm">
                                                                <i class="ft-edit-2"></i> Edit
                                                            </a>
                                                        <?php } ?>
                                                    <?php } ?>
                                                    <a href="<?php echo base_url('monitoring/detail_data/get_form_detail_art/' . enc(['id' => $artdata['id']])) ?>" class="btn btn-info bg-light-info btn-sm">
...
<div class="modal fade text-left" id="modal_tambah_kk" tabindex="-1" role="dialog" aria-labelledby="tambah_kk_mod" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="<?php echo base_url('monitoring/kartu_keluarga/tambah'); ?>" enctype="multipart/form-data">>
                <input type="hidden" name="proses_id" value="<?= $proses_id ?>">
                <div class="modal-body">
                    <div class="modal-body">
                        ...
                        <fieldset class="form-group">
                            <label for="user_email">Pilih Foto KK</label>
